class Stylist
  ...
  # define_singleton_method(:search) do |searched_stylist|
  #   stylists = DB.exec("SELECT * FROM stylists WHERE name = '#{searched_stylist}';")
  #   found_stylists = []
  #   stylists.each() do |stylist|
  #    current_stylist = Stylist.new(:name => stylist.fetch('name'), :id => stylist.fetch('id').to_i())
  #    found_stylists.push(current_stylist)
  #   end
  #   found_stylists
  # end
